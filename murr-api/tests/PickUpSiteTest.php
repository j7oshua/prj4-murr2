...
//    private array $pickupwithsiteNegOne;
//    private array $pickupwithsiteNinetyNine;
//    private array $pickupwithsiteNull;
...
//        dump($this->pickup);
    ...
    public function TestBinsCollected(): void
    {
        ...
        $response = static::createClient()->request('POST', self::API_URL, ['json' => $this->pickupHC]);
...
//     * @test
//     */
//    public function TestBinsContaminated(): void
//    {
...
//     * @test
//     */
//    public function TestBinsObstructed(): void
//    {
...
//     * @test
//     */
//    public function TestBinsCollectedAndObstructed(): void
//    {
...
//     * @test
//     */
//    public function TestBinsObstructAndContaminated(): void
//    {
...
//     * @test
//     */
//    public function TestSiteDoesNotExistNegativeOutOfBounds(): void
//    {
//        //this will index the -1 site id,
//        self::createClient()->request('POST', self::API_URL, ['json' => $this->pickupwithsiteNegOne[0]]);
//
...
//     * @test
//     */
//    public function TestSiteDoesExistPositiveOutOfBounds(): void
//    {
//        //this will index the 99 site id, which does not exists
//        self::createClient()->request('POST', self::API_URL, ['json' => $this->pickupwithsiteNinetyNine[0]]);
//        $this->assertResponseStatusCodeSame(404);
//        $this->assertResponseHeaderSame('content-type', 'application/ld+json; charset=utf-8');
//
//        //expected hydra result
...
//     * @test
//     */
//    public function TestValidNumberOfBinsMoreThanFour(): void
//    {
...
//     * @test
//     */
//    public function TestAllBinsZero(): void
//    {
...
//        self::createClient()->request('POST', self::API_URL, ['json' => $this->pickupwithsiteNull[0]]);
